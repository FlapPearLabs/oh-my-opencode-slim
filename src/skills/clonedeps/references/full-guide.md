# Clonedeps — Full Guide

## Librarian Clone Plan Prompt

Delegate dependency discovery and source resolution to `@librarian` using this prompt:
...
## Register Dependency Source in AGENTS.md
